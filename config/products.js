const products = [
  ...
  // BOILER PIPING
  { sku:'9', title: ' Радиаторная сеть', category: { id: 'boiler-piping', title: 'Выбор типа объвязки котельной' }, price: 1000, service_price: 100, form: { type: 'radio', name: 'radiator' }, description: '', img_src: '#' },
  { sku:'10', title: 'Радиаторы + теплый пол', category: { id: 'boiler-piping', title: 'Выбор типа объвязки котельной' }, price: 1000, service_price: 100, form: { type: 'radio', name: 'radiator' }, description: '', img_src: '#' },
  { sku:'11', title: 'Радиаторы + теплый пол + бойлер косвенного нагрева', category: { id: 'boiler-piping', title: 'Выбор типа объвязки котельной' }, price: 1000, service_price: 100, form: { type: 'radio', name: 'radiator' }, description: '', img_src: '#' },
